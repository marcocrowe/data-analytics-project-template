...
# print(github.create_jupyter_notebook_header("marcocrowe", "data-analytics-project-template", "notebooks/notebook-1-02-dc-twitter-api.ipynb", "master")
# -->
# <table style="margin: auto;"><tr><td><a href="https://mybinder.org/v2/gh/marcocrowe/data-analytics-project-template/master?filepath=notebooks/notebook-1-02-dc-twitter-api.ipynb" target="_parent"><img src="https://mybinder.org/badge_logo.svg" alt="Open In Binder"/></a></td><td>online editors</td><td><a href="https://colab.research.google.com/github/marcocrowe/data-analytics-project-template/blob/master/notebooks/notebook-1-02-dc-twitter-api.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a></td></tr></table>
...
# Remote option
# %pip install -r https://raw.githubusercontent.com/marcocrowe/data-analytics-project-template/notebook-1-02-dc-twitter-api/requirements.txt
# Options: --quiet --user
...
def download_user_tweets(
    o_auth_handler: tweepy.OAuthHandler,
    screen_name: str,
    ...
    oldest_id = None
    while True:
        tweets_result_set = tweepy_api.user_timeline(
...
user_tweets: list[tweepy.models.Status] = download_user_tweets(
    o_auth_handler, screen_name, True
)
...
# %% [markdown]
# Author &copy; 2022 <a href="https://github.com/marcocrowe" target="_parent">Mark Crowe</a>. All rights reserved.
