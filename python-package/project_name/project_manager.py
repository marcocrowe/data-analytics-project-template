...
class ProjectArtifactManager(RepositoryFileManager):
    ...
    def __init__(
        ...
        self.POPULATION_EDA_FILENAME: str = (
            "artifacts/population-1950-2021-eda-output.csv"
        )
...
class ProjectAssetManager(RepositoryFileManager):
    ...
    def __init__(
        ...
        super().__init__(repository_url, relative_path, is_remote)
        self.POPULATION_ESTIMATES_FILENAME: str = (
            "assets/2021-12Dec-11-population-estimates-1950-2021-pea01.csv"
        )
